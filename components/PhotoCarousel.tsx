...
const slides: Slide[] = [
  {
    src: "/images/exec-team.jpg",
    alt: "DPSU 2026-2028 Executive Team",
    caption: "Meet the 2026–2028 Executive Team",
    fit: "contain",
  },
  {
    src: "/images/president.jpeg",
    alt: "DPSU President at an international labour conference",
    caption: "Representing Dominica on the world stage",
    fit: "cover",
    objectPosition: "50% 25%",
  },
  {
    src: "/images/conferences.jpg",
    alt: "DPSU members at a training session",
    caption: "Investing in our members through training",
    fit: "cover",
  },
  {
    src: "/images/general-meeting.jpg",
    alt: "DPSU general membership meeting",
    caption: "Standing together at our general meetings",
    fit: "cover",
  },
];
