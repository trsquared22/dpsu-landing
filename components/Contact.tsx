...
// TODO: swap in DPSU's real Facebook page URL and confirmed office phone number.
const socials = [
  {
    label: "Email",
    href: "mailto:dominicapsu@gmail.com",
  ...
  {
    label: "Facebook",
    href: "#", // PLACEHOLDER — replace with DPSU's real Facebook page URL
  ...
  {
    label: "Phone",
    href: "tel:+1767XXXXXXX", // PLACEHOLDER — replace with DPSU's real office number
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-neutral-50 py-32 text-center text-neutral-900">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute bottom-0 left-1/2 h-[30rem] w-[50rem] -translate-x-1/2 rounded-full bg-navy-light/30 blur-[120px]"
      />
        ...
        <div className="mt-16 flex items-center justify-center gap-6">
          {socials.map((social) => (
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-black/10 bg-white text-neutral-500 shadow-sm transition hover:border-gold/50 hover:text-navy"
            >
